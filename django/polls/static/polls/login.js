        ...
        <div class="row justify-content-evenly">
            <div class="col">
                <main class="form-signin w-100 m-auto">
                    <form>
                        ...
                        <button class="btn btn-image w-100 py-2 route" type="button" id="profile-btn" data-path="/profile">Sign in</button>
                    </form>
            ...
            <div class="col">
                <main class="form-signin w-100 m-auto">
                    <form>
                        <div class="form-floating mb-2">
                            <input type="name" class="form-control" id="NameSignUp" placeholder="Name">
                            <label for="floatingInput">Name</label>
                        </div>
                        <div class="form-floating mb-2">
                            <input type="email" class="form-control" id="EmailSignUp" placeholder="name@example.com">
                            <label for="floatingInput">Email address</label>
                        </div>
                        <div class="form-floating mb-2">
                        ...
                        <div class="form-floating mb-3">
                            <input type="password" class="form-control" id="ConfirmPasswordSignUp" placeholder="Confirm Password">
                            <label for="floatingPassword">Confirm Password</label>
                        </div>
                        <!--type tiene que ser button en vez de submit para que vaya a la siguiente pagina-->
                        <!--tiene que mostrar un mensaje para que haga sign in despues de hacer sign up-->
                        <button class="btn btn-image w-100 py-2" type="button">Sign up</button>
                    </form>
                </main>
            </div>
        </div>
